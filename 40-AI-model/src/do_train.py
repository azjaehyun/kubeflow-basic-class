...
if __name__ == "__main__":
    ...
    parser.add_argument("--train_fp", type=str, help="학습 데이터들이 포함된 디렉토리 경로 or 학습 데이터 파일 경로 설정")
    parser.add_argument("--valid_fp", type=str, help="검증 데이터들이 포함된 디렉토리 경로 or 검증 데이터 파일 경로 설정")
    parser.add_argument("--base_path", type=str, help="Model이나 Encoder를 저장할 경로 설정", default="./ckpt/model/")
    ...
    parser.add_argument("--cmd", type=str, help="실행된 명령어", default="sh ./scripts/model/do_train.sh")
