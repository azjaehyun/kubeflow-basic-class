...
class Encoder:
    ...
    def get_encoder(self):
        if self.enc_sentiment is None or self.enc_aspect is None or self.enc_aspect2 is None:
    ...
    def __iter__(self):
        ...
        for now_fp in self.file_list:
            ...
            for i in range(len(sentences)):
                self.s_len += 1
                yield self.parsing_data(sentences[i], aspects[i], aspects2[i], sentiments[i])
